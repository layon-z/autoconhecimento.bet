...
// ---------- Bandeirinhas por país ----------
export const FLAGS = {
  'Brazil': '🇧🇷', 'Argentina': '🇦🇷', 'France': '🇫🇷', 'England': '🏴󠁧󠁢󠁥󠁮󠁧󠁿', 'Spain': '🇪🇸',
  'Portugal': '🇵🇹', 'Netherlands': '🇳🇱', 'Belgium': '🇧🇪', 'Germany': '🇩🇪', 'Italy': '🇮🇹',
  'Croatia': '🇭🇷', 'Uruguay': '🇺🇾', 'Colombia': '🇨🇴', 'Morocco': '🇲🇦', 'Switzerland': '🇨🇭',
  'USA': '🇺🇸', 'United States': '🇺🇸', 'Mexico': '🇲🇽', 'Senegal': '🇸🇳', 'Japan': '🇯🇵',
  'Serbia': '🇷🇸', 'Denmark': '🇩🇰', 'South Korea': '🇰🇷', 'Korea Republic': '🇰🇷', 'Canada': '🇨🇦',
};
export function flagOf(name) { return FLAGS[name] || '🏳️'; }
